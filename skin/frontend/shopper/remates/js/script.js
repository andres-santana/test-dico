...
jQuery(document).ready(function($){
    ...
    jQuery(document).ready(function($){
    	$("#form-rastreo").submit(function() {
    		...
    		$iframe = '<iframe src="https://prontoform.dico.com.mx/rastreo.html?cliente='+$valor_cliente+'&pedido='+$valor_pedido+'" frameborder=0 width="691px" height="550px" scrolling="no"> </iframe>'
