    ...
    jQuery(document).ready(function($){
        $("#form-rastreo").submit(function() {
            ...
            else if( $robot!="")
            {
                ...
                $("#form-container").hide();
            $iframe = '<iframe src="https://prontoform.dico.com.mx/rastreo.html?cliente='+$valor_cliente+'&pedido='+$valor_pedido+'" frameborder=0 width="691px" height="800px" scrolling="no"> </iframe>'
