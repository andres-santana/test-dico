...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( !empty($fecha) OR !empty($referencia)) {
			...
			try {
				...
				$_referencia = getStringBetween($result,"<nb_referencia>","</nb_referencia");
				...
				$_resultout["ccname"] = $_nombre;
				$_resultout ["ccnum"]= $_num_tarjeta;
				$_resultout ["amount"]= $_importe;
				$_resultout ["type"]= $_tipo_tarjeta;
				$_resultout ["reference"]= $_referencia;
				$_resultout ["aut"]= $_nu_auth;
				$_resultout ["response"]= $_response;
				if($_resultout):
					echo json_encode($_resultout);
				endif;
