...
if(Mage::getStoreConfig('advancedpermissions/settings/enabled') == '0')
{
	...
	class Int_Advancedpermissions_Block_Permissions_User_Edit_Tab_Main extends Mage_Adminhtml_Block_Permissions_User_Edit_Tab_Main
	{
	...
	class Int_Advancedpermissions_Block_Permissions_User_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form
	{
		...
		protected function _prepareForm()
		{
			...
			if(empty($userId) || $userType != NULL){
				$fieldset->addField('usertype', 'select', array(
								'name'  	=> 'usertype',
								'label' 	=> Mage::helper('adminhtml')->__('User Type'),
								'id'    	=> 'is_active',
								'title' 	=> Mage::helper('adminhtml')->__('User Type'),                        
								'style'		=> 'width: 115px',
								'options'	=> array('' => Mage::helper('adminhtml')->__('Select User Type'),'store_user' => Mage::helper('adminhtml')->__('Store User'), 'vender_user' => Mage::helper('adminhtml')->__('Vendor User')),
