...
if(Mage::getStoreConfig('advancedpermissions/settings/enabled') == '0'){
	class Int_Advancedpermissions_Block_Sales_Order_Create_Search_Grid extends Mage_Adminhtml_Block_Sales_Order_Create_Search_Grid
	{
	...
	class Int_Advancedpermissions_Block_Sales_Order_Create_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
	    ...
	    protected function _prepareCollection()
	    {
	        ...
	        if($userModel = Mage::getSingleton('admin/session')->getUser()){
	        	$userType = $userModel->getUsertype();        	
	        	if($userType != NULL && $userType == 'vender_user') {
