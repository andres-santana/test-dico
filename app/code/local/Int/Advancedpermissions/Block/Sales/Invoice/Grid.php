...
{
	class Int_Advancedpermissions_Block_Sales_Invoice_Grid extends Mage_Adminhtml_Block_Sales_Invoice_Grid
	{
	...
	class Int_Advancedpermissions_Block_Sales_Invoice_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
