...
if(Mage::getStoreConfig('advancedpermissions/settings/enabled') == '0')
{
	...
	class Int_Advancedpermissions_Block_Review_Grid extends Mage_Adminhtml_Block_Review_Grid
	{
	...
	class Int_Advancedpermissions_Block_Review_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
		...
		protected function _prepareCollection()
		{
			...
			if($userType != NULL){
				...
				$collection->addAttributeToFilter("stores", $userObj->getCurrentUserStoreView());
			}
