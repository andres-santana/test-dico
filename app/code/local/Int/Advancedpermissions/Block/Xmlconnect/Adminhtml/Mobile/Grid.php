...
if(Mage::getStoreConfig('advancedpermissions/settings/enabled') == '0')
{
	...
	class Int_Advancedpermissions_Block_Xmlconnect_Adminhtml_Mobile_Grid extends Mage_Xmlconnect_Block_Adminhtml_Mobile_Grid
	{	 
	...
	class Int_Advancedpermissions_Block_Xmlconnect_Adminhtml_Mobile_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
		/**
		 * Class constructor
		 */
