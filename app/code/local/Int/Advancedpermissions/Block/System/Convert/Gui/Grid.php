...
if(Mage::getStoreConfig('advancedpermissions/settings/enabled') == '0'){
	...
	class Int_Advancedpermissions_Block_System_Convert_Gui_Grid extends Mage_Adminhtml_Block_System_Convert_Gui_Grid
	{
	...
	class Int_Advancedpermissions_Block_System_Convert_Gui_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
