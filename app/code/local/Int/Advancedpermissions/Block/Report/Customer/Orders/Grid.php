...
{
	class Int_Advancedpermissions_Block_Report_Customer_Orders_Grid extends Mage_Adminhtml_Block_Report_Customer_Orders_Grid
	{
	}
	
} else {
	 
	class Int_Advancedpermissions_Block_Report_Customer_Orders_Grid extends Int_Advancedpermissions_Block_Report_Grid
	{
