...
{ 
	class Int_Advancedpermissions_Block_Report_Customer_Accounts_Grid extends Mage_Adminhtml_Block_Report_Customer_Accounts_Grid
	{
	}

} else {
	 
	class Int_Advancedpermissions_Block_Report_Customer_Accounts_Grid extends Int_Advancedpermissions_Block_Report_Grid
	{
