...
{
	class Int_Advancedpermissions_Block_Report_Customer_Totals_Grid extends Mage_Adminhtml_Block_Report_Customer_Totals_Grid
	{
	}

} else {
	 
	class Int_Advancedpermissions_Block_Report_Customer_Totals_Grid extends Int_Advancedpermissions_Block_Report_Grid
	{
