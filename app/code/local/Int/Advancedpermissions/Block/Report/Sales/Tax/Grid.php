...
{
	class Int_Advancedpermissions_Block_Report_Sales_Tax_Grid extends Mage_Adminhtml_Block_Report_Sales_Tax_Grid
	{
	}

} else { 
	 
	class Int_Advancedpermissions_Block_Report_Sales_Tax_Grid extends Int_Advancedpermissions_Block_Report_Grid_Abstract
	{
