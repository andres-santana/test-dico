...
{
	class Int_Advancedpermissions_Block_Report_Tag_Popular_Grid extends Mage_Adminhtml_Block_Report_Tag_Popular_Grid
	{
	}

} else {
	 
	class Int_Advancedpermissions_Block_Report_Tag_Popular_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
