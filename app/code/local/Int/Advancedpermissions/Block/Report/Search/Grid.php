...
{
	class Int_Advancedpermissions_Block_Report_Search_Grid extends Mage_Adminhtml_Block_Report_Search_Grid
	{
	...
	class Int_Advancedpermissions_Block_Report_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
	    /**
