...
if(Mage::getStoreConfig('advancedpermissions/settings/enabled') == '0')
{
	...
	class Int_Advancedpermissions_Block_Report_Shopcart_Product_Grid extends Mage_Adminhtml_Block_Report_Shopcart_Product_Grid
	{
	...
	class Int_Advancedpermissions_Block_Report_Shopcart_Product_Grid extends Mage_Adminhtml_Block_Report_Grid_Shopcart
	{
