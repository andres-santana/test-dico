...
{ 
	class Int_Advancedpermissions_Block_Report_Product_Viewed_Grid extends Mage_Adminhtml_Block_Report_Product_Viewed_Grid
	{
	}

} else {
	 
	class Int_Advancedpermissions_Block_Report_Product_Viewed_Grid extends Int_Advancedpermissions_Block_Report_Grid_Abstract
	{
		/**
