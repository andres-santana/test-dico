...
{ 
		class Int_Advancedpermissions_Block_Report_Product_Sold_Grid extends Mage_Adminhtml_Block_Report_Product_Sold_Grid
		{
		}
		
} else { 
	 
	class Int_Advancedpermissions_Block_Report_Product_Sold_Grid extends Int_Advancedpermissions_Block_Report_Grid
	{
		/**
		 * Sub report size
		 *
