...
{
	class Int_Advancedpermissions_Block_Promo_Quote_Edit_Tab_Labels extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Labels
	{
	...
	class Int_Advancedpermissions_Block_Promo_Quote_Edit_Tab_Labels 
		...
		protected function _prepareForm()
		{
			...
			if($userType != NULL){
				...
				foreach (Mage::app()->getWebsites() as $website) {
					if(in_array($website->getId(),$userObj->getCurrentUserWebsite())){
						...
						foreach ($website->getGroups() as $group) {
							if(in_array($group->getId(), $userObj->getCurrentUserStore())){
								...
								foreach ($stores as $store) {
									if(in_array($store->getId(), $userObj->getCurrentUserStoreView())){
