...
{
	class Int_Advancedpermissions_Block_Promo_Quote_Grid extends Mage_Adminhtml_Block_Promo_Quote_Grid
	{
	...
	class Int_Advancedpermissions_Block_Promo_Quote_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
		/**
		 * Initialize grid
		 * Set sort settings
