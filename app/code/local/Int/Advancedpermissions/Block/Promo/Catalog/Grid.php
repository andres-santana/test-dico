...
{
	class Int_Advancedpermissions_Block_Promo_Catalog_Grid extends Mage_Adminhtml_Block_Promo_Catalog_Grid
	{
	...
	class Int_Advancedpermissions_Block_Promo_Catalog_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
		/**
		 * Initialize grid
		 * Set sort settings
		...
		protected function _prepareCollection()
		{
			...
			if($userType != NULL){
				...
				$collection->addFieldToFilter('website_ids', $userObj->getCurrentUserWebsite());
			}
