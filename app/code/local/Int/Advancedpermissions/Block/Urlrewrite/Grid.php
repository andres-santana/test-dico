...
{
	class Int_Advancedpermissions_Block_Urlrewrite_Grid extends Mage_Adminhtml_Block_Urlrewrite_Grid
	{
	
	}
	
} else {
	class Int_Advancedpermissions_Block_Urlrewrite_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
