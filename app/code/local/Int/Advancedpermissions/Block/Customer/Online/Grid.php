...
if(Mage::getStoreConfig('advancedpermissions/settings/enabled') == '0'){
	...
	class Int_Advancedpermissions_Block_Customer_Online_Grid extends Mage_Adminhtml_Block_Customer_Online_Grid
	{
	...
	class Int_Advancedpermissions_Block_Customer_Online_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
		/**
