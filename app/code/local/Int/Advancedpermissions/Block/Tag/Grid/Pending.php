...
{ 
	class Int_Advancedpermissions_Block_Tag_Grid_Pending extends Mage_Adminhtml_Block_Tag_Grid_Pending
	{
	...
	class Int_Advancedpermissions_Block_Tag_Grid_Pending extends Mage_Adminhtml_Block_Widget_Grid
	{
		/**
		 * Constructor
		 *
