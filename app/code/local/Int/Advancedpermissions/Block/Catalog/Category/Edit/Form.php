...
{
	class Int_Advancedpermissions_Block_Catalog_Category_Edit_Form extends Mage_Adminhtml_Block_Catalog_Category_Edit_Form
	{
	...
	class Int_Advancedpermissions_Block_Catalog_Category_Edit_Form extends Mage_Adminhtml_Block_Catalog_Category_Abstract
	{
		/**
