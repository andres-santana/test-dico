...
class Int_Advancedpermissions_Block_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tabs
{
    protected function _prepareLayout()
    {
		$original_results = parent::_prepareLayout();
        ...
        if ($setId) {
            ...
            $groupCollection = Mage::getResourceModel('eav/entity_attribute_group_collection')
				...
				if(substr_count(Mage::getVersion(), '1.5') < 0){
			...
			$this->addTab('vender', array(
                'label'     => Mage::helper('catalog')->__('Vendor'),
				'content'   => $this->_translateHtml($this->getLayout()
							->createBlock('adminhtml/catalog_product_edit_tab_vender')->toHtml()),
            ));
