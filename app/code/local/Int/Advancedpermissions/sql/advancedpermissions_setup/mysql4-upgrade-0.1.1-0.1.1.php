...
DROP TABLE IF EXISTS {$this->getTable('user_category')};

CREATE TABLE {$this->getTable('user_category')} (
  `user_id` int(11) NULL,
  `website_id` int(11) NULL,
  `store_id` int(11) NULL,  
  `storeview_id` varchar(255) NULL,  
...
INSERT INTO {$this->getTable('admin_role')} (`parent_id`, `tree_level`, `sort_order`, `role_type`,  `user_id`, `role_name`, `user_role_type`) VALUES(0, 1, 0, 'G',  0, 'Store user/vendor', 'store_role');
