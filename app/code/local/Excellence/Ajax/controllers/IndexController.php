        ...
        if ($params['isAjax'] == 1) {
            ...
            try {
                ...
                if (!$cart->getQuote()->getHasError()) {
					...
					$message2 = $this->getLayout()->getBlock('cart_top')->toHtml();
                    $response['cart_top'] = $sidebar_header;
					$store_url = Mage::getBaseUrl();
					$response['message'] = "<iframe id='ajaxIframe' src='".$store_url."ajaxcart' frameborder=0 seamless='seamless' scrolling='no' width=670 ></iframe>";
                }
