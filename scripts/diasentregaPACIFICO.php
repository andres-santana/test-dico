...
if ($file) {
  foreach ($file as $line) {
    ...
    if($_product && $tiempo_entrega!=0){
      ...
      Mage::getSingleton('catalog/product_action')->updateAttributes(array($_product->getId()), $attrData, 8);
      echo "Producto actualizado [SKU][".$sku."] - [Tiempo de entrega][".$tiempo_entrega."]"."<br>";  
      $log = new Log("tiempoEntrega_".$fecha, "/home/cloudpanel/htdocs/dico.com.mx/scripts/logs/pacifico/");
