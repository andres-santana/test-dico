...
require_once '/home/cloudpanel/htdocs/bajio.dico.com.mx/app/Mage.php';
umask(0);
Mage::app();

$file = file('http://prontoform.dico.com.mx/ExistenciasWEB/BajioProd/ExistWeb.csv');
$data = [];
$n=0;
...
if ($file) {
  foreach ($file as $line) {
    ...
    if($_product && $tiempo_entrega!=0){
      ...
      Mage::getSingleton('catalog/product_action')->updateAttributes(array($_product->getId()), $attrData, 12);
      echo "Producto actualizado [SKU][".$sku."] - [Tiempo de entrega][".$tiempo_entrega."]"."<br>";  
      $log = new Log("tiempoEntrega_".$fecha, "/home/cloudpanel/htdocs/dico.com.mx/scripts/logs/noroeste/");
