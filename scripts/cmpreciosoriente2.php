...
$file = '/home/cloudpanel/htdocs/dico.com.mx/var/import/cambio_masivo_precios_oriente2.xls';
...
/*		case '3': $store_code = 14; break;
	...
	for ($i = 1; $i <= $data->sheets[$n]['numRows']; $i++) {
		if($i>1){
			...
			$precio[$i] = $data->sheets[$n]['cells'][$i][2];
			$precio_especial[$i] = $data->sheets[$n]['cells'][$i][3];
			$precio_agrupado[$i] = $data->sheets[$n]['cells'][$i][4];
			$precio_especial_agrupado[$i] = $data->sheets[$n]['cells'][$i][5];
